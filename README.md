...
... Установлен Webpack c Pug. Git tag Pug

---

### Расширения для VS Code
1. Pug to HTML - открываем "Палитру команд" `Ctrl + Shift + P` и вводим `>Pug to html` - и наш файл *.pug преобразуется в HTML и открывается рядом. При редактировании Pug-файла HTML-файл сразу меняется, оперативно можно посмотреть результат.